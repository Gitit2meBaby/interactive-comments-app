    ...
    async function generateStoredReplyContainers() {
        ...
        `;
                        ...
                        if (replyData.user.username === data.currentUser.username) {
                            // Get elements specific to this reply
                            ...
                            const replyImg = document.querySelector('.reply-image')
                            // Remove 'hidden' class and update text content
                            you.classList.remove('hidden');
                            deleteContainer.classList.remove('hidden');
                            replyText.textContent = 'Edit';
                            replyImg.src = "images/icon-edit";
                        } else replyImg = "images/icon-reply"
